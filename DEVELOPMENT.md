...
```sh
python3 tools/stage_addon.py --toc HammerLink.toc --addon-name HammerLink --output /mnt/backup/syncthing/kevin/myaddons/_staging
```

For the provisional Camelot preview, substitute `HammerLink_Camelot.toc` once
it has been brought into this clone. Syncthing delivers `_staging/HammerLink`
